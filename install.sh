#!/usr/bin/env bash
#
# slidev-deck-stack skill 安裝腳本（macOS / Linux）
...
SRC_DIR="$SCRIPT_DIR/skills/slidev-deck-stack"
SKILLS_DIR="$HOME/.claude/skills"
DEST_DIR="$SKILLS_DIR/slidev-deck-stack"
...
echo ""
echo "驗證安裝："
echo "  head -5 ~/.claude/skills/slidev-deck-stack/SKILL.md"
echo ""
echo "建議在做簡報的專案 CLAUDE.md 加入："
echo "  本專案簡報遵循 slidev-deck-stack skill，Slidev 整合規範以該 skill 鐵則為準。"
